...
void FMeteorModule::ConsumeMouse0Delta(
	int32& OutX,
	int32& OutY
)
{
	...
	{
		DualMouseMessageHandler->ConsumeMouse0Delta(
			OutX,
			OutY
		);
	}
...
void FMeteorModule::ConsumeMouse1Delta(
	int32& OutX,
	int32& OutY
)
{
	...
	if (DualMouseMessageHandler.IsValid())
	{
		DualMouseMessageHandler->ConsumeMouse1Delta(
			OutX,
			OutY
		);
	}
